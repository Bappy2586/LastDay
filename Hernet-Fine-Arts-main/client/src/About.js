...
import { ArtistList, AddArtist, UpdateArtist } from './component/AdminDashboard/Artist/ArtistCategoryList'; // Correct import path
    ...
    <Router>
      <div className="App">
        ...
        <Routes>
          ...
          {/* Artist Category CRUD Routes */}
          <Route path="/artist-categories" element={<ArtistList />} />
          <Route path="/add-artist-category" element={<AddArtist />} /> {/* Changed path for clarity */}
          <Route path="/update-artist-category/:id" element={<UpdateArtist />} /> {/* Changed path for clarity */}
